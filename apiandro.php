    ...
    if ($validtoken) {
        ...
        if ($result) {
            if ($result['idclient'] !== null) {
                ...
                //echo "L'utilisateur est un client. ID client : " . $result['idclient'];
                $type = "client";
                $iduser = $result['idclient'];
            } elseif ($result['idcommercial'] !== null) {
    
                //echo "L'utilisateur est un commercial. ID commercial : " . $result['idcommercial'];
                $type = "commercial";
        ...
        // Récupérer les logements réservés avec accept = 2 et les dates dans la plage spécifiée
        if ($type == "commercial"){
